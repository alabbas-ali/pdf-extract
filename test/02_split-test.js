...
describe('02 Split Test', () => {
	it('should split multi-page pdf in single page pdf files', (done) => {
		...
		split(pdf_path, (err, output) => {
			...
			async.forEach(
				...
				(file, cb) => {
					...
					fs.exists(file.file_path, (exists) => {
	...
	it('should split single page pdf into a new single page pdf files', (done) => {
		this.timeout(10 * 1000)
		this.slow(2 * 1000)
